...
<script>
    export default {
        data () {
            return {
                headers: [
                    { title: '項目名', key: 'itemName', sortable: false, align: 'center' },
                    { title: '備考', key: 'remark', sortable: false, align: 'center' },
                    { title: '有効期間', key: 'validPeriod', sortable: false, align: 'center' },
                    { title: '入力タイプ', key: 'entertype', sortable: false, align: 'center' },
                    { title: '選択肢グループ名', key: 'choiceGroupName', sortable: false, align: 'center', width: 30},
