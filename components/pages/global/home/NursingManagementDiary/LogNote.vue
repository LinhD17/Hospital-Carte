<template>
  <div class="log-note">
    <div class="d-flex">
      <div class="table-title">日誌特記</div>
      <v-btn rounded variant="outlined" color="primary" class="log-note__btn">
        前日取り込み
      </v-btn>
    </div>

    <v-textarea dense variant="solo" hide-details="auto" rows="4"></v-textarea>
    <div class="mt-7">
...
.log-note :deep(.v-list-item) {
  min-height: 24px;
}

.log-note :deep(.v-item-group) {
  padding-top: 10px;
  padding-bottom: 10px;
}
</style>
