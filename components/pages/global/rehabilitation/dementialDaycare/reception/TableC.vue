  ...
  <div class="table-parent">
    ...
    >
      ...
      <template v-slot:item.program= "{ item }">
        <div
          v-for="(program, index) in item.raw.program"
          :key="index"
        >
          <a>{{ item.raw.program.name  }}</a>
        </div>
      </template>
      ...
      <template v-slot:item.memo="{ item }">
        <div class="d-flex justify-space-between">
          ...
          <div>
            ...
            <v-icon v-if="item.raw.memo" small class="mr-1">mdi-delete </v-icon>
          </div>
        </div> 
      </template>
      ...
      data () {
        return {
          ...
          headers: [
            ...
            { title: '主治医', key: 'main_doctor', align:'center', sortable: false},
